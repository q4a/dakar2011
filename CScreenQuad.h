...
public:
	CScreenQuad(bool useATI, bool pflip_vert)
	{
        ...
        //if ((useATI && !pflip_vert) && !(useATI && pflip_vert))
        {
		  ...
		  Vertices[4] = irr::video::S3DVertex(-1.0f,-1.0f,0.0f,0,0,1,irr::video::SColor(0x0),0.0f,0.0f);
		  Vertices[5] = irr::video::S3DVertex( 1.0f, 1.0f,0.0f,0,0,1,irr::video::SColor(0x0),1.0f,1.0f);
        }
        else
        {
